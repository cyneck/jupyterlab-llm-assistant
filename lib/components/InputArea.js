...
// ── Component ─────────────────────────────────────────────────────────────────
export const InputArea = ({ onSend, disabled, mode, onModeChange, rootDir, }) => {
    ...
    const handleAttachDirAsChip = useCallback((suggestion) => {
        setAttachedPaths(prev => {
            if (prev.find(a => a.path === suggestion.path))
                return prev;
    ...
    // ── Remove a path chip ────────────────────────────────────────────────────
    const handleRemoveChip = useCallback((id) => setAttachedPaths(prev => prev.filter(a => a.id !== id)), []);
    // ── Image handling ────────────────────────────────────────────────────────
    ...
    const browseDirDisplay = browseDir
        ...
        : null;
    // ── Render ────────────────────────────────────────────────────────────────
    return (_jsxs("div", { className: "llm-input-area", children: [attachedPaths.length > 0 && (_jsx("div", { className: "llm-attached-chips", children: attachedPaths.map(a => (_jsxs("div", { className: `llm-chip ${a.isDir ? 'llm-chip-dir' : 'llm-chip-file'}`, children: [_jsx("span", { className: "llm-chip-icon", children: a.isDir ? (_jsx("svg", { viewBox: "0 0 24 24", width: "11", height: "11", fill: "currentColor", children: _jsx("path", { d: "M10 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z" }) })) : (_jsx("svg", { viewBox: "0 0 24 24", width: "11", height: "11", fill: "currentColor", children: _jsx("path", { d: "M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z" }) })) }), _jsx("span", { className: "llm-chip-label", title: a.path, children: a.path.split('/').pop() || a.path }), _jsx("button", { className: "llm-chip-remove", onMouseDown: e => { e.preventDefault(); handleRemoveChip(a.id); }, title: "Remove", children: _jsx("svg", { viewBox: "0 0 24 24", width: "10", height: "10", fill: "currentColor", children: _jsx("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" }) }) })] }, a.id))) })), images.length > 0 && (_jsx("div", { className: "llm-image-previews", children: images.map(image => (_jsxs("div", { className: "llm-image-preview", children: [_jsx("img", { src: image.preview, alt: "Preview" }), _jsx("button", { className: "llm-image-remove", onClick: () => handleRemoveImage(image.id), title: "Remove image", children: _jsx("svg", { viewBox: "0 0 24 24", width: "14", height: "14", fill: "currentColor", children: _jsx("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" }) }) })] }, image.id))) })), atIdx !== -1 && (_jsxs("div", { className: "llm-mention-menu", ref: mentionMenuRef, children: [browseDirDisplay && (_jsxs("div", { className: "llm-mention-breadcrumb", children: [_jsx("button", { className: "llm-mention-breadcrumb-back", onMouseDown: e => {
                                    e.preventDefault();
                                    const parts = browseDir.split('/');
                                    parts.pop();
                                    setBrowseDir(parts.join('/'));
                                }, title: "Go up", children: _jsx("svg", { viewBox: "0 0 24 24", width: "12", height: "12", fill: "currentColor", children: _jsx("path", { d: "M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z" }) }) }), _jsx("span", { className: "llm-mention-breadcrumb-path", children: browseDirDisplay })] })), loadingSuggestions ? (_jsx("div", { className: "llm-mention-loading", children: "Loading\u2026" })) : suggestions.length === 0 ? (_jsx("div", { className: "llm-mention-empty", children: "No matches" })) : (suggestions.map((s, i) => (_jsxs("div", { className: `llm-mention-item ${i === suggestionIdx ? 'active' : ''}`, onMouseDown: e => {
                            e.preventDefault();
                            if (s.isDir) {
                        ...
                        }, onMouseEnter: () => setSuggestionIdx(i), children: [_jsx("span", { className: "llm-mention-icon", children: s.isDir ? (_jsx("svg", { viewBox: "0 0 24 24", width: "13", height: "13", fill: "currentColor", children: _jsx("path", { d: "M10 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z" }) })) : (_jsx("svg", { viewBox: "0 0 24 24", width: "13", height: "13", fill: "currentColor", children: _jsx("path", { d: "M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z" }) })) }), _jsx("span", { className: "llm-mention-label", title: s.path, children: s.label }), _jsx("span", { className: "llm-mention-path", children: s.path }), s.isDir && (_jsx("button", { className: "llm-mention-attach-dir", onMouseDown: e => {
                                    e.stopPropagation();
                                    e.preventDefault();
                                    handleAttachDirAsChip(s);
                                }, title: "Attach entire directory", children: _jsx("svg", { viewBox: "0 0 24 24", width: "11", height: "11", fill: "currentColor", children: _jsx("path", { d: "M19 13H13v6h-2v-6H5v-2h6V5h2v6h6v2z" }) }) }))] }, s.path)))), _jsxs("div", { className: "llm-mention-hint", children: ["\u2191\u2193 navigate \u00B7 Enter/Tab select \u00B7 Esc close \u00B7 Backspace up", ' ', suggestions.some(s => s.isDir) && '· click folder to browse · + to attach dir'] })] })), _jsx("textarea", { ref: textareaRef, className: "llm-text-input llm-text-input-large", value: text, onChange: handleTextChange, onKeyDown: handleKeyDown, onPaste: handlePaste, placeholder: `Message (@ to reference files/dirs · paste images · Ctrl+Enter or Enter to send)`, disabled: disabled, rows: 4 }), _jsxs("div", { className: "llm-input-toolbar", children: [_jsxs("div", { className: "llm-mode-selector", children: [_jsx("svg", { className: "llm-mode-selector-icon", viewBox: "0 0 24 24", width: "13", height: "13", fill: "currentColor", children: _jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15v-4H7l5-8v4h4l-5 8z" }) }), _jsxs("select", { className: "llm-mode-select", value: mode, onChange: e => onModeChange(e.target.value), disabled: disabled, title: "Switch mode", children: [_jsx("option", { value: "chat", children: "Chat" }), _jsx("option", { value: "agent", children: "Agent" }), _jsx("option", { value: "plan", children: "Plan" })] }), _jsx("svg", { className: "llm-mode-select-chevron", viewBox: "0 0 24 24", width: "12", height: "12", fill: "currentColor", children: _jsx("path", { d: "M7 10l5 5 5-5z" }) })] }), _jsxs("span", { className: "llm-input-hint-text", children: [modeLabel, " \u00B7 Ctrl+Enter to send"] }), _jsxs("div", { className: "llm-input-actions", children: [_jsx("input", { ref: imageInputRef, type: "file", accept: "image/*", multiple: true, onChange: handleImageSelect, style: { display: 'none' } }), _jsx("button", { className: "llm-toolbar-btn", onClick: () => imageInputRef.current?.click(), disabled: disabled, title: "Attach image", children: _jsx("svg", { viewBox: "0 0 24 24", width: "16", height: "16", fill: "currentColor", children: _jsx("path", { d: "M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z" }) }) }), _jsx("input", { ref: fileInputRef, type: "file", multiple: true, onChange: async (e) => {
                                    const files = e.target.files;
                                    if (!files)
                                        return;
                                ...
                                }, style: { display: 'none' } }), _jsx("button", { className: "llm-toolbar-btn", onClick: () => fileInputRef.current?.click(), disabled: disabled, title: "Attach file", children: _jsx("svg", { viewBox: "0 0 24 24", width: "16", height: "16", fill: "currentColor", children: _jsx("path", { d: "M16.5 6v11.5c0 2.21-1.79 4-4 4s-4-1.79-4-4V5c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5v10.5c0 .55-.45 1-1 1s-1-.45-1-1V6H10v9.5c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5V5c0-2.21-1.79-4-4-4S7 2.79 7 5v12.5c0 3.04 2.46 5.5 5.5 5.5s5.5-2.46 5.5-5.5V6h-1.5z" }) }) }), _jsx("button", { className: "llm-send-btn", onClick: handleSend, disabled: !canSend, title: "Send (Ctrl+Enter)", children: _jsx("svg", { viewBox: "0 0 24 24", width: "18", height: "18", fill: "currentColor", children: _jsx("path", { d: "M2.01 21L23 12 2.01 3 2 10l15 2-15 2z" }) }) })] })] })] }));
};
